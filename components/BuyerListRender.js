...
export const BuyerListRender = ({ item, favourite, onPress, favouriteUpdate, imageUri }) => {
    ...
    return (
        <TouchableOpacity onPress={onPress} activeOpacity={0.5} style={{ width: '40%', backgroundColor: '#F8F8F8', borderRadius: 24, paddingVertical: 20, marginHorizontal: 10, marginTop: 10 }}>
